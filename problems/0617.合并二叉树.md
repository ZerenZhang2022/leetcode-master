...
class Solution:
    def mergeTrees(self, root1: Optional[TreeNode], root2: Optional[TreeNode]) -> Optional[TreeNode]:
        ...
        while stack:
            ...
            if cur1.left and cur2.left: stack.append([cur1.left,cur2.left])
            if cur1.right and cur2.right: stack.append([cur1.right,cur2.right])
            if cur2.left and not cur1.left: cur1.left = cur2.left
            if cur2.right and not cur1.right: cur1.right = cur2.right
        return root1
```
